...
class ClemGroupes
{
    ...
    public function mesGroupes()
    {
        ...
        if ($_GET["page"] == "gaming-groupes" || $_POST["send"] == "ok" || $_POST["action"] == "delete-groupe") {
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'delete-groupe') {
                // on exécute la méthode save_client
                $db->delete_groupe($_POST['delete-groupe']);
            }

            // on instancie la classe Ern_List
            $table = new Tp_List_Groupes();
            ...
            echo "<div>" .
                ...
                "<input type='text' name='groupe' id='groupe' class='widefat' required>" .
                "</div>";
            // input submit
            echo "<div>" .
