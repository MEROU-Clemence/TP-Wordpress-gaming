...
== Upgrade Notice ==
* 5.2.3: Added a communication mechanism to allow the firewall to send data to WordPress, some tweaks and fixes. See changelog for full details. A recommended update for all.
